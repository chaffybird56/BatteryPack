...
@click.command()
@click.option("--out-dir", type=click.Path(file_okay=False, path_type=Path), default=Path("outputs/demo"))
def main(out_dir: Path) -> None:
	...
	print(f"Demo complete. Outputs saved to: {out_dir}")
