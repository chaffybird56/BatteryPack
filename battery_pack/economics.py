...
class CostModel:
	...
	def calculate_capital_cost(
		...
		total_energy_wh = (
			num_cells * cell_capacity_ah * nominal_voltage_v / pack_params.series_cells
		)
...
class GridEconomics:
	...
	def calculate_grid_service_revenue(
		...
		service_revenue = pack_power_kw * self.params.grid_service_revenue_per_kw * (
			utilization_hours_per_year / 8760.0
		)
