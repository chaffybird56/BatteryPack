...
def constant_current_constant_voltage(
    ...
    while soc_current < charging_params.soc_target:
        ...
        ocv_cell = cell_params.ocv_floor_v + (cell_params.ocv_ceiling_v - cell_params.ocv_floor_v) * soc_current
        ...
        # Transition phase
            ...
            # Linear transition
            transition_factor = (soc_current - charging_params.cc_phase_soc) / (
